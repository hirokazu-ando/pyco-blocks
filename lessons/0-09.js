...
window.PYCO_LESSONS["0-09"] = {
  ...
  "mode": "python",
  "articleUrl": "https://sakigake-robo.com/courses/pycoblocks/pycoblocks-part0-intro/pycoblocks-09-for/",
  "toolbox": [
    "pico_for_range",
    "pico_repeat",
    "py_print",
  ...
  "steps": [
    ...
    },
    {
      "quiz": true,
      "title": "課題：くり返してみよう",
      "body": "<p><b>くり返し</b> ブロックの中に <b>値を表示する</b> を入れて、好きな回数だけ表示するプログラムを作りましょう。くり返しブロックを1つ使えばクリアです。</p><p>もっとくわしく → 解説記事 <code>https://sakigake-robo.com/courses/pycoblocks/pycoblocks-part0-intro/pycoblocks-09-for/</code></p>",
