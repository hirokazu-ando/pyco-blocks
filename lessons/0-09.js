  ...
  "steps": [
    {
      ...
      "bodyEasy": "<p>同じことを何度もするとき、表示ブロックを並べるのは大変です。<b>for文</b> を使うと、決まった回数だけ <b>くり返せます</b>。</p><ul><li><b>range(3)</b>：3回くり返す（数える数は 0, 1, 2）</li><li>くり返しの中に置いた処理が回数ぶん動く</li></ul>",
    ...
    },
    {
      ...
      "bodyEasy": "<p>「繰り返し」カテゴリから <b>変数 i を N 回繰り返す</b> ブロックを出して置きます。回数のあなに <b>数値</b> の <code>3</code> を入れます。</p><p>1つ置けたらクリアです。</p>",
    ...
    },
    {
      ...
      "bodyEasy": "<p>くり返しの中に <b>「Hello」を表示する</b> を入れます（<b>値を表示する</b> に文字列 <code>Hello</code>）。</p><p>「▶ 実行」で <code>Hello</code> が3行出れば成功です。</p><pre>for i in range(3):\n    print(\"Hello\")</pre>",
    ...
    },
    {
      ...
      "bodyEasy": "<p>くり返しには <b>カウンタ変数</b>（ここでは <code>i</code>）があります。<code>range(3)</code> のとき <code>i</code> は <b>0 → 1 → 2</b> と1回ごとに変わります。数え始めは <b>0</b> です。</p>"
    },
    {
      "track": "block",
      "title": "手順3：iを表示する",
      ...
      "bodyEasy": "<p>くり返しの中で <b>値を表示する</b> に <b>変数</b> <code>i</code> をはめます。</p><p>「▶ 実行」で <code>0</code>・<code>1</code>・<code>2</code> と3行出れば成功です。</p><pre>for i in range(3):\n    print(i)</pre>",
    ...
    },
    {
      ...
      "bodyEasy": "<p>次を実行すると数が3行出ます。<b>1行目</b>に出る数はいくつでしょう？</p><pre class=\"code-lines\">for i in range(3):\n    print(i + 1)</pre>",
    ...
    },
    {
      ...
      "bodyEasy": "<p><b>for</b> と <b>range</b> を使って <code>0</code>・<code>1</code>・<code>2</code> を1行ずつ表示しましょう。</p><pre class=\"code-lines\">0\n1\n2</pre>",
    ...
    },
    {
      ...
      "bodyEasy": "<p><code>for i in range(3):</code> のとき、<code>i</code> はどんな順に変わるでしょう？</p>",
      "check": {
        "choice": {
          "options": [
            "0, 1, 2",
    ...
    },
    {
      ...
      "bodyEasy": "<p>次のプログラムは <code>A</code> を何行出すでしょう？</p><pre>for i in range(5):\n    print(\"A\")</pre>",
      "check": {
        "choice": {
          "options": [
            "5行",
    ...
    },
    {
      ...
      "bodyEasy": "<p><b>くり返し</b> の中に <b>値を表示する</b> を入れて、好きな回数だけ表示しましょう。くり返しブロックを1つ使えばクリアです。</p>",
