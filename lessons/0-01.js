...
window.PYCO_LESSONS["0-01"] = {
  ...
  "steps": [
    ...
    {
      "title": "手順1：表示ブロックを置く",
      "body": "<p>左のパレットから <b>「Hello」を表示する</b> ブロックを取り出し、下の図のようにワークスペースへ置きましょう。</p><p>1つ置けたら下の「✓ クリア！」が点灯します。</p>",
    ...
    {
      "title": "コードを読もう",
      "body": "<p>右上のコードエリアには、次の1行が出ています。1行ずつ意味を確認しましょう。</p><pre class=\"code-lines\">print(16)</pre><ul><li><b>1行目</b>：<code>print</code> で <code>( )</code> の中身を表示します。ここでは <code>16</code> を <code>\"</code> で囲んでいません。<code>\"</code> で囲まない数字は <b>数値</b> としてあつかわれ、計算に使えます。文字列の <code>\"16\"</code> とは別ものです。</li></ul>",
      "callout": {
        "target": "code",
