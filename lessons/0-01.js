  ...
  "steps": [
    {
      ...
      "bodyEasy": "<p>前回は「Hello」を1つ表示しました。今回は <code>print</code> をもっと使います。</p><ul><li>ブロックを <b>縦につなぐ</b> と何行でも表示できる</li><li>文字だけでなく <b>数値</b> も表示できる</li><li><b>区切り線</b> で見やすくなる</li></ul><p>じゅんびができたら「次へ ▶」を押してください。</p>",
    ...
    },
    {
      ...
      "bodyEasy": "<p>パレットから <b>「Hello」を表示する</b> ブロックを取り出し、下の図のようにワークスペースへ置きましょう。</p><p>１つ置けたら「✓ クリア！」が光ります。</p>",
    ...
    },
    {
      ...
      "bodyEasy": "<p>表示ブロックを2つ縦につなぎ、下の図のように文字を <code>おはよう</code> と <code>PycoBlocks</code> にしましょう。</p><p>「▶ 実行」を押して2行出れば成功です。</p><pre>おはよう\nPycoBlocks</pre>",
      ...
      "image": {
        "src": "lessons/img/0-01_two_prints.png",
        "alt": "表示ブロックを2つ縦につないだ組み合わせ"
      }
    },
    {
      "track": "block",
      ...
      "bodyEasy": "<p>「表示」には役割のちがうブロックがあります。</p><ul><li><b>「Hello」を表示する</b>：文字をそのまま表示</li><li><b>値を表示する</b>：数値や計算の答えを表示</li><li><b>区切り線を表示する</b>：<code>----------------</code> の線を引く</li></ul><p>「Hello」の方は <code>\"...\"</code> で囲んだ文字を、「値」の方は囲まずに値をそのまま出します。次で数値を出してみましょう。</p>"
    },
    {
      "track": "block",
      ...
      "bodyEasy": "<p><b>値を表示する</b> ブロックに、「値」カテゴリの <b>数値</b> ブロックをはめて、数を <code>16</code> にします。下の図のように組みましょう。</p><p>「▶ 実行」を押して <code>16</code> と出れば成功です。</p><pre>print(16)</pre>",
      ...
      "image": {
        "src": "lessons/img/0-01_print16.png",
        "alt": "数値ブロック16をはめた値を表示するブロック"
      }
    },
    {
      "track": "code",
      ...
      "bodyEasy": "<p>コードエリア（スマホは「コード・実行」タブ）に、次の1行が出ています。</p><pre class=\"code-lines\">print(16)</pre><ul><li><b>1行目</b>：<code>print</code> で <code>( )</code> の中を表示します。<code>16</code> は <code>\"</code> で囲んでいません。囲まない数字は <b>数値</b> になり、計算に使えます。文字列の <code>\"16\"</code> とは別ものです。</li></ul>",
      "callout": {
        "target": "code",
        "text": "右上に同じ print(16) が出ています",
        "placement": "left"
      }
    },
    {
      ...
      "bodyEasy": "<p><code>print(\"1+2\")</code> を実行すると、何が出るでしょう？</p>",
      "check": {
        "choice": {
          "options": [
            "1+2（文字のまま）",
    ...
    },
    {
      ...
      "bodyEasy": "<p>では <code>print(1 + 2)</code>（<code>\"</code> で囲まない）を実行すると、何が出るでしょう？</p>",
      "check": {
        "choice": {
          "options": [
            "3（計算した結果）",
    ...
    },
    {
      ...
      "bodyEasy": "<p>表示ブロックを <b>3つ縦につないで</b>、名前・出身地・好きなものを3行で表示しましょう。ブロックが3つ置けたらクリアです。</p><p>組み合わせ例：</p>",
      ...
      "image": {
        "src": "lessons/img/0-01_three_prints.png",
        "alt": "表示ブロックを3つ縦につないだ例"
      }
    },
    {
      "track": "code",
      ...
      "bodyEasy": "<p>次のコードを実行すると、<b>2行目</b>には何が表示されるでしょう。</p><pre class=\"code-lines\">print(\"Python\")\nprint(2024)</pre>",
      "hint": "1行目は文字列、2行目は数値をそのまま表示します。2行目の値を答えます。",
      "check": {
        "answerText": {
          "accept": [
            "2024"
    ...
    },
    {
      ...
      "bodyEasy": "<p><b>コード編集モード</b> でPythonを直接書いて、次の2行を表示しましょう。</p><pre class=\"code-lines\">Hello\nPython</pre><p><code>print</code> を2つ使って、1行ずつ表示します。</p>",
      "hint": "print(\"Hello\") と print(\"Python\") を1行ずつ書きます。",
      "check": {
        "codeRun": {
          "outputEquals": "Hello\nPython",
          "codeContains": [
            {
              "pattern": "print",
              "message": "print を使って表示しましょう"
            }
          ],
          "codeForbids": [
            {
              "pattern": "\\\\n",
              "message": "1つの print に \\n を書かず、print を2つ使って2行に分けましょう"
            }
          ]
        }
      }
