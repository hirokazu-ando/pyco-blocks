...
window.PYCO_LESSONS["0-19"] = {
  ...
  "mode": "python",
  "article": "https://sakigake-robo.com/courses/pycoblocks/pycoblocks-part0-intro/pycoblocks-19-tuple-set/",
  "toolbox": [
    "py_tuple_literal",
    "py_tuple_unpack",
    "py_set_literal",
  ...
  "steps": [
    {
      ...
      "bodyEasy": "<p>リストににた、べつのデータを2つ学びます。</p><ul><li><b>タプル</b>（tuple）：<code>( )</code> で作る。作った後は <b>変えられない</b>。ざひょうや色に向く</li><li><b>セット</b>（set）：<code>{ }</code> で作る。<b>同じ値は消える</b>・<b>順番がない</b></li></ul><p>変えられないセットは <b>frozenset</b> です。</p>",
    ...
    },
    {
      ...
      "bodyEasy": "<p>「タプル・セット」カテゴリから <b>タプル ( … )</b> のブロックを取り出して、下の図のように置きましょう。中に2つの数を入れられます。</p><p>1つ置けたらクリアです。</p>",
    ...
    },
    {
      ...
      "bodyEasy": "<p>下の図のように組み立てましょう。</p><ol><li><b>変数 point</b> に <b>タプル (3, 7)</b> を入れる</li><li><b>変数 x, y = タプル point</b> のブロックで、2つの値を <code>x</code> と <code>y</code> に分ける（アンパック＝タプルの中身をいくつかの変数に一度に入れること）</li><li><b>値を表示する</b> で <code>x</code>、つぎに <code>y</code> を表示する</li></ol><p>「▶ 実行」を押して <code>3</code> と <code>7</code> が2行出れば成功です。</p><pre>3\n7</pre>",
    ...
    },
    {
      ...
      "bodyEasy": "<p>セットは <b>同じ値を1つ</b> にまとめます。ただし順番がないので、そのままだと並びは決まりません。</p><p><b>リスト〜の重複を除いて昇順に並べる</b> のブロックを使うと、重複を消して小さい順にできます。</p><p>2つのセットを比べる計算（和 <code>|</code>・積 <code>&amp;</code>・差 <code>-</code>）も使えます。</p>"
    },
    {
      "track": "block",
      "title": "手順3：重複を消して並べる",
      ...
      "bodyEasy": "<p>下の図のように組み立てましょう。</p><ol><li><b>変数 scores</b> に <b>リスト</b> <code>[80, 90, 80, 70]</code> を入れる</li><li><b>値を表示する</b> に <b>scores の重複を除いて昇順に並べる</b> をはめる</li></ol><p>「▶ 実行」を押して、重複が消えて小さい順に並んだリストが出れば成功です。</p><pre>[70, 80, 90]</pre>",
    ...
    },
    {
      ...
      "bodyEasy": "<p>次のコードを実行すると、何が表示されるでしょう？数字で答えてください。</p><pre class=\"code-lines\">color = (255, 128, 0)\nr, g, b = color\nprint(g)</pre>",
    ...
    },
    {
      ...
      "bodyEasy": "<p>タプル <code>(10, 20)</code> を作り、<b>アンパック</b>で2つの変数に分けて、その2つをたした結果を表示するコードを書いて実行しましょう。</p><pre class=\"code-lines\">30</pre>",
    ...
    },
    {
      ...
      "bodyEasy": "<p><b>タプル</b> の正しい説明はどれでしょう？</p>",
      "check": {
        "choice": {
          "options": [
            "作った後は中身を変更できない",
    ...
    },
    {
      ...
      "bodyEasy": "<p>セット <code>{1, 2, 2, 3}</code> の要素はいくつになるでしょう？（セットは同じ値を消す）</p>",
      "check": {
        "choice": {
          "options": [
            "3個",
    ...
    },
    {
      ...
      "quiz": true,
      "title": "課題：重複をなくそう",
      "body": "<p>好きな数を並べたリストを作り、<b>重複を除いて昇順に並べる</b> ブロックで整理して表示するプログラムを作ってみましょう。そのブロックを使えばクリアです。</p><p>組み合わせ例：</p>",
      "bodyEasy": "<p>好きな数をならべたリストを作り、<b>重複を除いて昇順に並べる</b> ブロックで整理して表示するプログラムを作りましょう。そのブロックを使えばクリアです。</p><p>組み合わせ例：</p>",
