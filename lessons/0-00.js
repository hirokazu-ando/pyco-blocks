...
window.PYCO_LESSONS["0-00"] = {
  ...
  "steps": [
    ...
    {
      "track": "block",
      "title": "操作のコツ：ブロックの消し方",
      "body": "<p>まちがえて置いたブロックや、いらなくなったブロックは、いつでも消せます。方法は3つあります。</p><ul><li><b>ゴミ箱へドラッグ</b>：ブロックをつかんで、ワークスペース右下の<b>ゴミ箱</b>の上まで運んで指をはなすと消えます。</li><li><b>右クリックで消す</b>：ブロックを右クリックし、出てきたメニューから <b>「ブロックを削除」</b> を選びます。つながったブロックをまとめて選んでいるときは「○個のブロックを削除」と表示されます。</li><li><b>Deleteキーで消す</b>：ブロックを1回クリックして選んでから、キーボードの <code>Delete</code>（または <code>Back Space</code>）キーを押します。</li></ul><p>まちがえて消してしまったときは、<code>Ctrl</code> キーと <code>Z</code> キーを同時に押すと元に戻せます。</p>",
      "bodyEasy": "<p>いらないブロックは、いつでも消せます。方法は3つあります。</p><ul><li><b>ゴミ箱へはこぶ</b>：ブロックをつかんで、右下のゴミ箱の上ではなすと消えます。</li><li><b>右クリック</b>：ブロックを右クリックして、<b>「ブロックを削除（さくじょ）」</b> を選びます。</li><li><b>Deleteキー</b>：ブロックを1回クリックしてから、キーボードの <code>Delete</code> キーを押します。</li></ul><p>まちがえて消しても、<code>Ctrl</code> と <code>Z</code> を同時に押せば元にもどせます。</p>",
      "hint": "ゴミ箱はワークスペースの右下にあります。ブロックを近づけるとフタが開きます。"
    },
    {
      "track": "block",
      "title": "ブロックとコードのつながり",
