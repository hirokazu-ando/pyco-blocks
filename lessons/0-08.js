  ...
  "steps": [
    {
      ...
      "bodyEasy": "<p>2つ以上の条件を組み合わせたいときに使うのが <b>論理演算（ろんりえんざん）</b> です。</p><ul><li><b>かつ（and）</b>：両方が正しいときだけ True</li><li><b>または（or）</b>：どちらか一方でも正しければ True</li><li><b>でない（not）</b>：正しい／まちがいを反対にする</li></ul>",
    ...
    },
    {
      ...
      "bodyEasy": "<p>「分岐」カテゴリから <b>かつ</b> ブロックを出して、左右へ <b>比較</b> をはめます。左に <code>x &gt;= 80</code>、右に <code>x &lt;= 100</code> を入れます。</p><p>組めたらクリアです。</p>",
    ...
    },
    {
      ...
      "bodyEasy": "<p>下の図のように組みます。</p><ol><li><b>変数 x を 85 にする</b></li><li><b>もし〜だったら</b> の条件に <b>かつ</b>（<code>x &gt;= 80</code> かつ <code>x &lt;= 100</code>）をはめる</li><li>中に <b>「PASS」を表示する</b> を入れる</li></ol><p><code>x</code> は <code>85</code> で両方正しいので、「▶ 実行」で <code>PASS</code> と出れば成功です。</p><pre>x = 85\nif x &gt;= 80 and x &lt;= 100:\n    print(\"PASS\")</pre>",
    ...
    },
    {
      ...
      "bodyEasy": "<p>残りの2つも見ます。</p><ul><li><b>または（or）</b>：<code>a == 0 or b == 0</code> は、どちらかが0なら True</li><li><b>でない（not）</b>：<code>not True</code> は <code>False</code>、<code>not False</code> は <code>True</code></li></ul>"
    },
    {
      "track": "block",
      ...
      "bodyEasy": "<p>下の図のように組みます。</p><ol><li><b>変数 is_raining を False にする</b></li><li><b>もし〜だったら</b> の条件に <b>でない</b> をはめ、中に <code>is_raining</code> を入れる</li><li>中に <b>「出発」を表示する</b> を入れる</li></ol><p><code>is_raining</code> は <code>False</code>、その <b>でない</b> は True なので、「▶ 実行」で <code>出発</code> と出れば成功です。</p><pre>is_raining = False\nif not is_raining:\n    print(\"出発\")</pre>",
    ...
    },
    {
      ...
      "bodyEasy": "<p>次を実行すると、何が出るでしょう？</p><pre class=\"code-lines\">a = 5\nif a &gt; 0 and a &lt; 10:\n    print(\"範囲内\")\nelse:\n    print(\"範囲外\")</pre>",
    ...
    },
    {
      ...
      "bodyEasy": "<p><b>変数 x を 85 にして</b>、<code>x</code> が <code>80</code> 以上 <b>かつ</b> <code>100</code> 以下なら <code>PASS</code>、そうでなければ <code>NG</code> を表示しましょう。<code>PASS</code> と出れば成功です。</p>",
    ...
    },
    {
      ...
      "bodyEasy": "<p><code>True and False</code>（かつ）の答えはどれでしょう？</p>",
      "check": {
        "choice": {
          "options": [
            "False（両方が正しくないとダメ）",
    ...
    },
    {
      ...
      "bodyEasy": "<p><code>True or False</code>（または）の答えはどれでしょう？</p>",
      "check": {
        "choice": {
          "options": [
            "True（どちらか一方でOK）",
    ...
    },
    {
      ...
      "bodyEasy": "<p><b>かつ</b> か <b>または</b> を使って、いくつもの条件をまとめて調べるプログラムを作りましょう。<b>もし〜だったら</b> と組み合わせ、<b>かつ</b> を1つ使えばクリアです。</p>",
