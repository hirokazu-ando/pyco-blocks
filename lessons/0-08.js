...
window.PYCO_LESSONS["0-08"] = {
  ...
  "mode": "python",
  "articleUrl": "https://sakigake-robo.com/courses/pycoblocks/pycoblocks-part0-intro/pycoblocks-08-logic/",
  "toolbox": [
    "pico_if",
    "cond_compare",
    "cond_and",
  ...
  "steps": [
    ...
    },
    {
      ...
      "body": "<p><b>かつ</b> または <b>または</b> を使って、複数の条件をまとめて判定するプログラムを作りましょう。<b>もし〜だったら</b> と組み合わせ、<b>かつ</b> ブロックを1つ使えばクリアです。</p><p>もっとくわしく → 解説記事 <code>https://sakigake-robo.com/courses/pycoblocks/pycoblocks-part0-intro/pycoblocks-08-logic/</code></p>",
