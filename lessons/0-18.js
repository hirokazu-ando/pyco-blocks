...
window.PYCO_LESSONS["0-18"] = {
  ...
  "mode": "python",
  "article": "https://sakigake-robo.com/courses/pycoblocks/pycoblocks-part0-intro/pycoblocks-18-string-methods/",
  "toolbox": [
    "py_str_split",
    "py_str_join",
    "py_str_strip",
  ...
  "steps": [
    ...
    },
    {
      ...
      "check": {
        "codeRun": {
          "outputEquals": "2024/01/15",
          "codeContains": [
            {
              "pattern": "\\.replace\\(",
              "message": "実行結果は合っていますが、replace を使って書いてみましょう"
            }
          ],
          "codeForbids": [
            {
              "pattern": "2024/01/15",
              "message": "実行結果は合っていますが、答えを直接書かず、replace で置きかえてみましょう"
            }
          ]
        }
      }
