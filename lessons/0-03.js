...
window.PYCO_LESSONS["0-03"] = {
  ...
  "mode": "python",
  "articleUrl": "https://sakigake-robo.com/courses/pycoblocks/pycoblocks-part0-intro/pycoblocks-03-math/",
  "toolbox": [
    "py_math_op",
    "val_number",
    "val_var",
  ...
  "steps": [
    ...
    },
    {
      "quiz": true,
      "title": "確認クイズ②",
      "body": "<p><code>2 ** 8</code>（<code>**</code> はべき乗）の結果はどれでしょう？</p><p>もっとくわしく → 解説記事 <code>https://sakigake-robo.com/courses/pycoblocks/pycoblocks-part0-intro/pycoblocks-03-math/</code></p>",
      "check": {
        "choice": {
          "options": [
            "256",
